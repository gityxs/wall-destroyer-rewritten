...
var cnItems = {
    ...
    "Zombieland": "僵尸乐园",
    "*sounds of incredibly crappy 8-bit horns*": "*令人难以置信的蹩脚 8 位喇叭的声音*",
    "Armament Armada": "武装舰队",
    "Come Together": "一起来",
    "damage to the wall with your gunshooters.": "用你的枪手损坏墙壁。",
    "Dead Rising": "丧尸围城",
    "Defiles the wall with the darkest magic of all.": "用最黑暗的魔法玷污墙壁。",
    "Destroy the final wall.": "摧毁最后一堵墙。",
    "Diamond Knuckles": "钻石指节",
    "Doing God's Work": "做上帝的工作",
    "Dream Building": "梦想大厦",
    "Energy Drinks": "能量饮品",
    "Enters reality code and removes the wall from existence.": "输入现实代码并将墙从存在中移除。",
    "Experimental Drugs": "实验药物",
    "fourth wall bricks.": "第四道墙砖。",
    "King of The Cosmos": "宇宙之王",
    "Legion of Fists": "拳头军团",
    "Ocean of Grenades": "手榴弹海",
    "POWERTHIIIRRRST": "POWERTHIIIRRRST",
    "Probably completely safe.": "可能是完全安全的。",
    "Robots covered in The Black. They're really cool, so no one questions mixing the most dangerous & evil thing ever with cold, unfeeling robots.": "黑色覆盖的机器人。 他们真的很酷，所以没有人质疑将有史以来最危险和邪恶的东西与冰冷、无情的机器人混合在一起。",
    "Swiss Cheese": "瑞士芝士",
    "The Chosen One": "被选中的人",
    "The Military": "军队",
    "The Old West": "老西部",
    "The only real substance that can make things do more damage than titanium.": "唯一能使事物造成比钛更大破坏的真实物质。",
    "The weak become strong(er).": "弱者变强（呃）。",
